...
const benefits = [
  {
    ...
    description: 'Reduce analysis time from hours to minutes with AI-powered insights and automated reporting.'
  },
  {
    icon: <LightbulbOutlinedIcon />,
    title: 'Smart Insights Discovery',
    description: 'Uncover hidden patterns and opportunities in your data that traditional tools miss.'
  },
  {
    icon: <AutoFixHighOutlinedIcon />,
    title: 'Automated Workflows',
    description: 'Eliminate repetitive tasks and focus on strategic decisions with intelligent automation.'
  }
];
