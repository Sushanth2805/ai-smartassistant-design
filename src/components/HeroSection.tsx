  ...
  return (
    <HeroContainer>
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, px: { xs: 2, md: 0 } }}>
        <Stack spacing={{ xs: 3, md: 4 }} alignItems="flex-start" sx={{ maxWidth: { xs: '100%', md: '800px' } }}>
          <HeroTitle variant="h1">
            Your smartest AI assistant{" "}
            <span className="highlight">work faster and smarter</span>
          </HeroTitle>

          <HeroSubtitle sx={{ maxWidth: { xs: '100%', md: '600px' } }}>
            Smarter sales, faster decisions. AI powered dashboard with call
            analytics, transcripts, summaries and more.
          </HeroSubtitle>

          <Stack direction="row" spacing={3} alignItems="center">
            <PrimaryButton endIcon={<ArrowForwardIosOutlinedIcon />}>
              GET STARTED
            </PrimaryButton>
